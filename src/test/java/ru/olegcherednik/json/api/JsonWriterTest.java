...
public class JsonWriterTest {
    ...
    public void shouldThrowJsonExceptionWhenWriteValueWithException() {
        Supplier<JsonEngine> supplier = mock(Supplier.class);
        when(supplier.get()).thenThrow(RuntimeException.class);

        JsonWriter jsonWriter = new JsonWriter(supplier);
    ...
    public void shouldThrowJsonExceptionWhenWriteValueToWriterWithException() {
        ...
        JsonWriter jsonWriter = new JsonWriter(supplier);
        assertThatThrownBy(() -> jsonWriter.writeValue("one", writer)).isExactlyInstanceOf(JsonException.class);
    }
